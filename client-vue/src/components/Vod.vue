    ...
    >
        ...
        <div class="video-description">
                    ...
                    <ul class="video-info">
                        ...
                        <template v-if="vod.dt_capture_started">
                            ...
                            <li>
                                ...
                                {{
                                    formatDate(
                                        vod.dt_conversion_started.date,
                                        "yyyy-MM-dd HH:mm:ss"
                                    )
                                }}
                            </li>
                    ...
                    <ul class="video-info">
                        ...
                        <template v-if="vod.video_metadata">
                            <li>
                                ...
                                {{ vod.video_metadata.video.Width }}x{{
                                    vod.video_metadata.video.Height
                                }}
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                {{
                                    Math.round(
                                        vod.video_metadata.video.BitRate / 1000
                                    )
                                }}kbps
                            </li>
                            <li>
                                ...
                                {{
                                    Math.round(
                                        vod.video_metadata.audio.BitRate / 1000
                                    )
                                }}kbps
                            </li>
                        </template>
                ...
                <div class="info-column">
                    ...
                    <ul class="video-info">
                        <template v-if="vod.twitch_vod_exists === true">
                            ...
                            <li>
                                <strong>Title:</strong>
                                <span v-if="vod.twitch_vod_title">
                            ...
                            <li>
                                ...
                                <span v-if="vod.twitch_vod_muted === true">
                                    <strong class="is-error">Yes</strong>
                                </span>
                                <span
                                    v-else-if="vod.twitch_vod_muted === false"
                                >
                                    <span>No</span>
                                </span>
                                <span v-else>
            ...
            <ul v-if="vod.is_capturing" class="video-info">
                <li>
                    <strong>Current duration:</strong> {{ vod.duration_live }}
                </li>
                <li>
        ...
        <div class="video-controls">
            ...
            <template v-if="vod.is_finalized">
                ...
                <a v-if="!vod.twitch_vod_id && !vod.is_chat_downloaded" class="button" href="#">
                    <span class="icon"><i class="fa fa-comments"></i></span> Download chat
                </a>
                

                <template v-if="vod.is_chat_downloaded && !vod.is_chat_burned">
                    <a class="button" href="#"><span class="icon"><i class="fa fa-comment"></i></span> Render chat</a>
                    <a v-if="vod.is_vod_downloaded" class="button" href="#"><span class="icon"><i class="fa fa-comment"></i></span> Render chat (vod)</a>
                </template>

                <template v-if="vod.twitch_vod_id">
                    <a v-if="!vod.is_vod_downloaded" class="button" href="#">
                        <span class="icon"><i class="fa fa-download"></i></span> Download{{ vod.twitch_vod_muted ? ' muted' : '' }} VOD
                    </a>
                    <a class="button" href="#"><span class="icon"><i class="fa fa-volume-mute"></i></span> Check mute</a>
                    <a v-if="!vod.is_chat_burned" class="button" href="#"><span class="icon"><i class="fa fa-burn"></i></span> Render &amp; burn</a>
                </template>

                <a class="button is-danger" href="#"><span class="icon"><i class="fa fa-trash"></i></span> Delete</a>                

            </template>
            <template v-else-if="vod.is_converting">

                <em><span class="icon"><i class="fa fa-file-signature"></i></span> Converting <strong>{{ vod.basename }}.ts</strong> to <strong>{{ vod.basename }}.mp4</strong></em><br />
                <em>
                    <span v-if="vod.api_getConvertingStatus"><span class="icon"><i class="fa fa-sync fa-spin"></i></span> Running (pid {{ vod.api_getConvertingStatus }})</span>
                    <span v-else><strong class="is-error flashing"><span class="icon"><i class="fa fa-exclamation-triangle"></i></span> Not running, did it crash?</strong></span>
                </em>
            </template>
            <template v-else-if="vod.is_capturing">

                <em>
                    <span class="icon"><i class="fa fa-video"></i></span> Capturing to <strong>{{ vod.basename }}.ts</strong> (<strong>{{ formatBytes(vod.api_getRecordingSize) }}</strong>)
                </em>
        ...
        <div class="video-chapters">
            <table class="table game-list">
                ...
                <tbody>
                    ...
                    <tr v-for="chapter in vod.chapters" :key="chapter" :class="{ 'favourite': $root.config.favourites[chapter.game_id] }">
                        ...
                        <td>
                            ...
                            <template v-if="vod.is_finalized">
                                ...
                                <a v-if="vod.twitch_vod_exists" :href="vod.twitch_vod_url + '?t=' + twitchDuration(chapter.offset)" target="_blank" rel="noreferrer" aria-label="Open on Twitch">
                    ...
                    <tr v-else>
                        <td v-if="vod.dt_started_at">{{ humanDuration(vod.api_getDurationLive) }}</td>
