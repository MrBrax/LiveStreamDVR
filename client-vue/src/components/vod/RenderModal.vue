<template>
    <div>
        <div>
            ...
            <ul v-if="vod.video_metadata" class="list">
            ...
            <div class="notice is-error">
                Burning chat seems to work pretty good, but dumped chat+video has a pretty large offset, I have yet to find the offset anywhere.
            </div>
        </div>
        <hr />
        ...
        <div class="field-group">
            <div class="field">
                <label
                    ><input v-model="burnSettings.renderChat" type="checkbox" /> {{ t("render-menu.render-chat") }}
                    <strong v-if="vod.is_chat_rendered">(Exists)</strong></label
                >
            </div>
            <template v-if="burnSettings.renderChat">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        ...
                        />
                        <br /><input v-model="burnSettings.chatWidth" class="input" type="number" />
                ...
                <div class="field">
                    ...
                    <div class="control">
                        ...
                        />
                        <br /><input v-model="burnSettings.chatHeight" class="input" type="number" />
                ...
                <div class="field">
                    ...
                    <div class="select">
                        <select v-model="burnSettings.vodSource">
                            <option value="captured">
                                {{ t("render-menu.source-captured") }}
                            </option>
                            <option value="downloaded" :disabled="!vod.is_vod_downloaded">
                ...
                <div class="field">
                    ...
                    <div v-if="vod.is_chatdump_captured || vod.is_chat_downloaded" class="select">
                        <select v-model="burnSettings.chatSource">
                            <option value="captured" :disabled="!vod.is_chatdump_captured">
                                {{ t("render-menu.source-captured") }}
                            </option>
                            <option value="downloaded" :disabled="!vod.is_chat_downloaded">
                                {{ t("render-menu.source-downloaded") }}
                            </option>
                        </select>
                    </div>
                    <div v-else class="notice is-error">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input v-model="burnSettings.chatFont" class="input is-fullwidth" list="font" />
                        <datalist id="font">
                            <option value="Arial" />
                            <option value="Inter" />
                        </datalist>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input v-model="burnSettings.chatFontSize" class="input" type="range" min="1" max="72" />
                        <br /><input v-model="burnSettings.chatFontSize" class="input" type="number" />
                    </div>
                </div>
            </template>
        </div>
        <div class="field-group">
            <div class="field">
                <label>
                    <input v-model="burnSettings.burnChat" type="checkbox" :disabled="!burnSettings.renderChat && !vod.is_chat_rendered" />
            ...
            <template v-if="burnSettings.burnChat">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input v-model="burnSettings.burnOffset" class="input" type="number" />
                    </div>
                </div>
                <div class="field">
                    <div class="control">
                        <input v-model="burnSettings.testDuration" type="checkbox" />
                ...
                <div class="field">
                    ...
                    <div class="select">
                        <select v-model="burnSettings.burnHorizontal">
                ...
                <div class="field">
                    ...
                    <div class="select">
                        <select v-model="burnSettings.burnVertical">
                ...
                <div class="field">
                    ...
                    <div class="select">
                        <select v-model="burnSettings.ffmpegPreset">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input v-model="burnSettings.ffmpegCrf" class="input" type="range" min="0" max="51" />
        ...
        <FormSubmit :form-status="formStatus" :form-status-text="formStatusText">
            <d-button color="success" icon="burn" @click="doRenderWizard">
                {{ t("buttons.execute") }}
            </d-button>
        </FormSubmit>
...
onMounted(() => {
    const chatHeight: number =
        props.vod && props.vod.video_metadata && props.vod.video_metadata.type !== "audio" && store.cfg<boolean>("chatburn.default.auto_chat_height")
