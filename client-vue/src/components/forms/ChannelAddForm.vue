<template>
    <form ref="form" method="POST" enctype="multipart/form-data" action="#" @submit="submitForm">
        <div class="field">
        ...
        <div v-if="channelData && channelData.login" class="field">
            <ul>
                <li>
                    Login: <strong>{{ channelData.login }}</strong>
                </li>
                <li>
                    Display name: <strong>{{ channelData.display_name }}</strong>
                </li>
                <li>
                    Description: <strong>{{ channelData.description }}</strong>
                </li>
        ...
        <div class="field">
            ...
            <div class="control">
                <input v-model="formData.match" class="input" type="text" name="match" />
        ...
        <p>
            <em>{{ t("forms.channel.live-channels-warning") }}</em>
        </p>
