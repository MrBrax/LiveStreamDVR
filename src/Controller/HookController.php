...
class HookController
{
    ...
    public function hook( Request $request, Response $response, $args )
    {
        ...
        TwitchHelper::log( TwitchHelper::LOG_INFO, "Hook called" );
        ...
        if ($post_json) {
            TwitchHelper::log( TwitchHelper::LOG_INFO, "Custom payload received..." );
            $data = json_decode($post_json, true);
        }

        if ($data) {

            TwitchHelper::log( TwitchHelper::LOG_INFO, "Dumping payload..." );
            ...
            */
            ...
            TwitchHelper::log( TwitchHelper::LOG_INFO, "Run handle..." );
            $TwitchAutomator->handle($data);

        } else {
            
            TwitchHelper::log( TwitchHelper::LOG_INFO, "Hook called with no data..." );
