...
export class Config {
    ...
    static readonly settingsFields: Array<SettingField<string> | SettingField<number> | SettingField<boolean>> = [
        ...
        { key: "capture.viewercount", group: "Capture", text: "Capture viewercount", type: "boolean", default: false, help: "Capture viewercount", new: true },
        ...
        { key: "capture.twitch-access-token-param", group: "Capture", text: "Twitch access token param", type: "string", new: true },
    ...
    loadConfig() {
        ...
        for (const setting of Config.settingsFields) {
            if (config[setting.key] === undefined && setting.default !== undefined) {
