...
export class Config {
    ...
    static readonly settingsFields: Array<SettingField<string> | SettingField<number> | SettingField<boolean>> = [
        ...
        { "key": "chat_dump", "group": "Basic", "text": "Dump chat during capture for all channels", "type": "boolean", "default": false, "help": "Dump chat from IRC, forgoing saved vod chat.", "deprecated": true },
